...
type ChartOut = {
  ...
  nakTable: NakRow[];
  dasha: DashaRow[];
  aspects: AspectPair[]; // server may include some; we also add Asc aspects locally
};
...
export default function Home() {
  /* Global style + print CSS + export toolbar styles */
  useEffect(() => {
    ...
    style.innerHTML = `
      ...
      .charts-row {
        display: grid;
        grid-template-columns: 1fr;  /* stack one below the other */
        gap: 16px;
        margin-top: 16px;
      }
      ...
      .export-row button {
        border:1px solid #ddd; background:#fff; padding:10px 14px; border-radius:8px;
      }
  ...
  /* -------- Exports (Save/Print PDF, JSON, CSV, Charts SVG/PNG, Save HTML) -------- */
        ...
        {out && (
          <div id="print-root" ref={printRef}>
            ...
            <section className="page-section first">
              ...
              {/* D1 & D9 (stacked on screen and print) */}
              ...
              <div className="export-row">
                <button onClick={() => window.print()} title="Save as PDF via browser print">Save / Print PDF</button>
